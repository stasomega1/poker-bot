...
- `/regame` — пересчитать последнюю игру после редактирования исходных сообщений; команда должна быть reply на ее `/game`
...
Если в исходных сообщениях с бай-инами или результатами обнаружена ошибка, отредактировать их и отправить `/regame` ответом на `/game`. Пересчитать можно только последнюю сохраненную игру.
